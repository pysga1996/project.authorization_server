...
public class ClientDTODaoTest {
    ...
    public void whenFindAll_thenReturn3Records() {
        List<ClientDTO> clientDTOList = jdbcTemplate.query("SELECT * FROM oauth_client_details", clientMapper);
    ...
    public void whenFindById_thenReturn1Record() {
        ...
        ClientDTO fooClientDTO = namedParameterJdbcTemplate.queryForObject("SELECT * FROM oauth_client_details WHERE client_id=:id", namedParameters, clientMapper);
